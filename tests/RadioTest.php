...
class RadioTest extends TestBase
{
    ...
    public function it_will_select_only_one_item()
    {
        ...
        $this->shouldWrite("\e[m❯ Happy" . str_repeat(' ', 73) . "\e[0m");
        $this->shouldWrite("\e[m  Sad" . str_repeat(' ', 75) . "\e[0m");
        $this->shouldReceiveSameLine();
        $this->shouldWrite("\e[m  Thrilled" . str_repeat(' ', 70) . "\e[10D\e[8m\e[0m");
        ...
        $this->shouldReceiveSameLine();
        $this->shouldWrite("\e[m  Happy" . str_repeat(' ', 73) . "\e[0m", 2);
        $this->shouldWrite("\e[m❯ Sad" . str_repeat(' ', 75) . "\e[0m");
        $this->shouldWrite("\e[m  Thrilled" . str_repeat(' ', 70) . "\e[10D\e[8m\e[0m");
